...
> Trying it out? Spin up any HTTP-transport MCP server (or use the bundled example endpoint) and connect. Want something meatier? [**fleet-mcp**](https://github.com/ridzkyyy/fleet-mcp) serves a live simulated GPS fleet — trucks, geofences, NMEA. Paste `https://fleet-mcp.vercel.app/mcp` into the connect bar and go.
